...
//        System.out.println("lvm cache key: " + key);
        ProxyClient proxyClient = cache.get(key);
        if (proxyClient == null) {
//        	System.out.println("new ProxyClient");
            proxyClient = new ProxyClient(lvm);
            cache.put(key, proxyClient);
        }else{
//        	System.out.println("get ProxyClient from cache");
        }
//        System.out.println("is dead: " + proxyClient.isDead);
        return proxyClient;
    }
